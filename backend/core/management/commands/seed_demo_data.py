    ...
    def handle(self, *args, **options):
        ...
        issues_data = [
            ...
            # Open-Source-Contribution-Drive Monorepo (Hackit-DROID)
            {
                ...
                'github_issue_id': 5327318709,
                'number': 101,
                'title': '[CR-101] Prevent Object-Level IDOR Vulnerability in `edit_stock` and `delete_stock` Views',
                'points': 20,
                'difficulty': 'medium',
                'category': 'security',
                'status': 'open',
                'is_featured': True,
                'labels': ['hackit-commitrush', 'difficulty:medium', 'type:security'],
            },
            {
                'project': projects['Open-Source-Contribution-Drive'],
                'github_issue_id': 5327319106,
                'number': 102,
                'title': '[CR-102] Automatically Assign `hospital_profile` to Created `BloodRequest` in `add_request` View',
                'points': 10,
                'difficulty': 'easy',
                'category': 'bug',
                'status': 'open',
                'is_featured': True,
                'labels': ['hackit-commitrush', 'difficulty:easy', 'type:bug'],
            },
            {
                'project': projects['Open-Source-Contribution-Drive'],
                'github_issue_id': 5327319447,
                'number': 103,
                'title': '[CR-103] Replace Broad Bare `except:` Clauses with `ObjectDoesNotExist` in Hospital Query Views',
                'points': 10,
                'difficulty': 'easy',
                'category': 'refactor',
                'status': 'open',
                'is_featured': True,
                'labels': ['hackit-commitrush', 'difficulty:easy', 'type:refactor'],
            },
            {
                'project': projects['Open-Source-Contribution-Drive'],
                'github_issue_id': 5327319754,
                'number': 104,
                'title': '[CR-104] Enforce Permission Checks (`is_hospital`) on `edit_donor` and `delete_donor` Views',
                'points': 10,
                'difficulty': 'easy',
                'category': 'security',
                'status': 'open',
                'is_featured': True,
                'labels': ['hackit-commitrush', 'difficulty:easy', 'type:security'],
            },
        ]
